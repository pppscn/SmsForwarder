...
class ClientFragment : BaseFragment<FragmentClientBinding?>(), View.OnClickListener, RecyclerViewHolder.OnItemClickListener<PageInfo> {
    ...
    private var CLIENT_FRAGMENT_LIST = listOf(
        PageInfo(
            getString(R.string.api_clone), "cn.ppps.forwarder.fragment.client.CloneFragment", "{\"\":\"\"}", CoreAnim.slide, R.drawable.icon_api_clone
        ),
        PageInfo(
            getString(R.string.api_sms_query), "cn.ppps.forwarder.fragment.client.SmsQueryFragment", "{\"\":\"\"}", CoreAnim.slide, R.drawable.icon_api_sms_query
        ),
        PageInfo(
            getString(R.string.api_sms_send), "cn.ppps.forwarder.fragment.client.SmsSendFragment", "{\"\":\"\"}", CoreAnim.slide, R.drawable.icon_api_sms_send
        ),
        PageInfo(
            getString(R.string.api_call_query), "cn.ppps.forwarder.fragment.client.CallQueryFragment", "{\"\":\"\"}", CoreAnim.slide, R.drawable.icon_api_call_query
        ),
        PageInfo(
            getString(R.string.api_contact_query), "cn.ppps.forwarder.fragment.client.ContactQueryFragment", "{\"\":\"\"}", CoreAnim.slide, R.drawable.icon_api_contact_query
        ),
        PageInfo(
            getString(R.string.api_contact_add), "cn.ppps.forwarder.fragment.client.ContactAddFragment", "{\"\":\"\"}", CoreAnim.slide, R.drawable.icon_api_contact_add
        ),
        PageInfo(
            getString(R.string.api_wol), "cn.ppps.forwarder.fragment.client.WolSendFragment", "{\"\":\"\"}", CoreAnim.slide, R.drawable.icon_api_wol
        ),
        PageInfo(
            getString(R.string.api_location), "cn.ppps.forwarder.fragment.client.LocationFragment", "{\"\":\"\"}", CoreAnim.slide, R.drawable.icon_api_location
        ),
        PageInfo(
            getString(R.string.api_battery_query), "cn.ppps.forwarder.fragment.client.BatteryQueryFragment", "{\"\":\"\"}", CoreAnim.slide, R.drawable.icon_api_battery_query
        ),
    )
